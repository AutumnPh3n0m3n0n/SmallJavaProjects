...
//this is the main file class for the
import java.util.*;
...
public class program4 {
    public static void main(String args[]) {
        ...
        treeStruct DataStructure = new treeStruct();
        DataStructure.importContents();
        ...
        do {
            do {
                ...
                System.out.println("Enter an E to set an exam");
                System.out.println("Enter an O for other type of event");
            ...
            if (choice == 'A') {
                toPutInsert = new appointments(subject1, subject2, setLocation, day, month, year, hour, minute);
            } else if (choice == 'E') {
                toPutInsert = new exams(subject1, subject2, setLocation, day, month, year, hour, minute);
            } else {
                toPutInsert = new recreation(subject1, subject2, setLocation, day, month, year, hour, minute);
            }
            do {
            ...
            DataStructure.setTNode(toPutInsert);
