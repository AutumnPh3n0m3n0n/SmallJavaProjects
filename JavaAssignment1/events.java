...
//events is an abstract base class
abstract public class events {
    ...
    public events(String addLocation, int day, int month, int year, int hour, int minute){
    ...
    public boolean laterThan(events toCompare){
